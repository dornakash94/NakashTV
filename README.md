...
Development source: **0.2.0-beta.1**. Published APK: [0.1.0-beta.1](https://github.com/dornakash94/NakashTV/releases/tag/v0.1.0-beta.1). See [development notes](docs/DEVELOPMENT.md) for the current workflow.
