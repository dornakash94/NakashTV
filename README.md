...
Development source: **0.2.0-beta.2**. Published APK: [0.2.0-beta.2](https://github.com/dornakash94/NakashTV/releases/tag/v0.2.0-beta.2). See [development notes](docs/DEVELOPMENT.md) for the current workflow.
