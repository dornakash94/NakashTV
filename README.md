...
Development source: **0.3.0-beta.3**. Published APK: [0.3.0-beta.3](https://github.com/dornakash94/NakashTV/releases/tag/v0.3.0-beta.3). See [development notes](docs/DEVELOPMENT.md) for the current workflow.
